				...
				<nav id="navigation" class="style-1" style="padding-top: 5px;">
					<ul id="responsive">
						...
						<li><a href="/review/viewReviewList">Review</a>
							<ul>
								<li><a href="/review/viewReviewList?categoryCode=CARE">Care</a></li>
 				...
 				<c:otherwise>
					...
					<div class="right-side">
						...
						<div class="header-widget" style="padding-top: 10px;"	>
							...
							<!-- User Menu -->
							<div class="user-menu">
								<div class="user-name"><span ><img src="/resources/upload/${member.photo}"  alt="" style="width: 38px; height: 38px; object-fit:cover;"></span>${member.nickname}</div>
								<ul>
